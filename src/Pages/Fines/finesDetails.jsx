...
import {
  ...
  Modal,
  ModalImg,
} from "../../Components/Modals/ModalTwo";
...
export const FinesDetail = () => {
  ...
  const handleEditClick = async (dataToUpdate) => {
    ...
    if (response.response != null) {
      ...
      sePaymentproof(response.response.results.paymentproof);
    } else {
      Swal.fire({
        icon: "error",
        title: "Oops...",
            ...
            >
              <ul className="list-unstyled">
                ...
                <li>
                  Para:{" "}
                  <Link
                    to={`/admin/apartments/details/${idApartment}`}
                  >{`Inquilinos apartamento ${apartmentName}`}</Link>{" "}
                </li>
                <br />
                ...
                <li>
                  Fecha de incidente: {moment(incidentDate).format("MMMM Do")}
                </li>
                <li>
                  Fecha limite de pago: {moment(paymentDate).format("MMMM Do")}
                </li>
            ...
            >
              {loadingFines ? (
                ...
                <div className="mt-4 ml-2">
                  <NotificationsAlert
                    to={`/admin/fines/create/${id}`}
                    msg={` para agregar un multa.`}
                  />
                </div>
              )}
            </DropdownInfo>
                ...
                onClick={() => {
                  setShowModal(false),
                    handleEditClick({
                      ...
                      idfines: id,
                      state: "Por revisar",
                      paymentproof: paymentproofFiles,
                    });
                }}
          ...
          <>
            <ModalContainer ShowModal={setAaddProofFilesModal}>
              <Modal
                ...
                title={paymentproof ? 'Cambiar comprobante' : 'Agregar comprobante de pago'}
